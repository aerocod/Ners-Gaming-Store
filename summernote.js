        ...
        o = (function() {
            var b = function(b) {
                ...
                na = function(a, b) {
                    ...
                    return (
                        i || d !== a.node || (i = a.node.childNodes[a.offset]), { rightNode: i, container: d }
                    );
                },
                oa = function(a) {
    ...
    var q = function(b, c, d, e) {
        ...
        E = r.create('<div class="note-color-palette"/>', function(a, b) {
            for (var c = [], d = 0, e = b.colors.length; d < e; d++) {
                for (
                    var f = b.eventName, g = b.colors[d], h = [], i = 0, j = g.length; i < j; i++
                ) {
                    var k = g[i];
                    h.push(
                        [
                ...
                return (
                    a.each(b, function(b, e) {
                        var f = m.head(e),
                            ...
                            o.splitTree(
                                h, { node: g.parentNode, offset: o.position(g) + 1 }, { isSkipPaddingBlankHTML: !0 }
                            ) :
                            null,
                            j = o.splitTree(
                                h, { node: f.parentNode, offset: o.position(f) }, { isSkipPaddingBlankHTML: !0 }
                            );
                        (e = c ?
                ...
                this.$handle.on("mousedown", function(a) {
                        if (o.isControlSizing(a.target)) {
                            ...
                            var e = c.$handle
                                ...
                                h = function(a) {
                                    b.invoke(
                                            "editor.resizeTo", { x: a.clientX - f.left, y: a.clientY - (f.top - g) },
                                            e, !a.shiftKey
                                        ),
                                        c.update(e[0]);
                                };
            ...
            var c = this,
                ...
                i = (this.representShortcut = function(a) {
                    ...
                    return f.shortcuts && b ?
                        (k.isMac && (b = b.replace("CMD", "âŒ˜").replace("SHIFT", "â‡§")),
                            " (" +
                            (b = b
                                .replace("BACKSLASH", "\\")
                                .replace("SLASH", "/")
